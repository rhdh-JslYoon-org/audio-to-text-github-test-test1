...
3) Access the `workbench` named `audio-to-text-github-test-test1-notebook`.
...
5) In the terminal, run `cd audio-to-text-github-test-test1` to navigate to your sample app's directory.
